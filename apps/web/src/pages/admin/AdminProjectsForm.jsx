...
//         .map((x) => x.trim())
//         .filter(Boolean),
//       content: data.content, // (plus tard: HTML TipTap)
...
//     // si secondary CONTACT, pas besoin d'URL
//     if (payload.ctaSecondaryType === "CONTACT") payload.ctaSecondaryUrl = "";

//     try {
//       const res = await fetch(
//         isEdit ? `/api/admin/projects/${id}` : "/api/admin/projects",
//         {
...
//           json?.message ||
//           json?.error ||
//           `Enregistrement impossible (HTTP ${res.status})`;
...
//       // en create: on redirige vers edit
...
//       // en edit, on reste sur la page
//     } catch {
//       setNotice({
//         type: "err",
//         text: "Erreur réseau. Vérifie que l’API tourne.",
//       });
//     } finally {
//       setSaving(false);
//     }
